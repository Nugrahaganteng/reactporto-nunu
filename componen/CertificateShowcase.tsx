...
export default class CertificateShowcase extends React.Component<{}, CertificateShowcaseState> {
  ...
  certificates: CertificateData[] = [
    ...
    {
      title: 'certificate yang saya dapat dari web libray manajement',
      description:
        'Note: banyak pengalman yang saya ambil dari pembuatan libray manajement bersama teman" sebaya saya',
